...
const TopStories = ({ loading, topStories, getTopArticles }) => {
            ...
            { loading ? (
                ...
                <div>
                    <div className={classes.buttons}>
                        ...
                        <Button onClick={() => {getTopArticles('technology');}} variant="outlined" color="primary">Tech News</Button>
                        <Button onClick={() => {getTopArticles('sports');}} variant="outlined" color="primary">Sports News</Button>
                    </div>
